...
<header class="header">
    ...
    <div class="header-inner">
        <div class="container-fluid">
            <div class="header__made"><img src="images/img-made-usa.jpg" alt=""></div>
            <div class="header__burger"><a href="#"><img src="images/icon-burger.png" alt=""></a></div><a class="header__logo" href="index.html"><img class="d-md-none" src="images/img-logo-mobile.png" alt=""><img class="d-none d-md-block" src="images/img-logo-desktop.png" alt=""></a>
            <div class="header__right">
                <div class="header__right-info">
                    <div class="header__purse">229 points</div><a class="header__login" href="#">Login  </a><a class="header__search-icon" href="#"><img src="images/icon-search.png" alt=""></a><a class="header__cart" href="#">
                        <div class="header__cart-total">$0.00</div><img src="images/icon-cart.png" alt=""></a>
                </div>
